...
public class AugmentedImageFragment extends ArFragment {
    ...
    private static final String DRONE_IMAGE_NAME = "desert.jpg";
    ...
    private boolean setupAugmentedImageDatabase(Config config, Session session) {
        ...
        if (USE_SINGLE_IMAGE) {
            ...
            Bitmap droneBitmap = loadAugmentedImageBitmap(assetManager, DRONE_IMAGE_NAME);
            if (droneBitmap == null) {
                return false;
            }
            ...
            augmentedImageDatabase.addImage(DRONE_IMAGE_NAME, droneBitmap);
